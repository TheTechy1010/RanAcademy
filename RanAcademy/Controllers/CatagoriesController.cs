...
namespace RanAcademy.Controllers
{
    public class CatagoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description")] Catagory catagory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description")] Catagory catagory)
        {
            if (ModelState.IsValid)
            {
